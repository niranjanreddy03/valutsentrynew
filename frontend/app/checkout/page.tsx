...
function CheckoutInner() {
  ...
  useEffect(() => {
    ...
    fetch('/api/razorpay/quote', {
      ...
      .then((data) => {
        if (!cancelled) setQuote({ amountMajor: data.displayAmount, currency: data.currency })
      })
      .catch(() => {
      ...
      const rzp = new window.Razorpay({
        ...
        handler: async (response) => {
          try {
            ...
            setSuccess(true)
            toast.success('Payment successful!', `Your ${plan.name} plan is active. Razorpay will email the invoice.`)
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-6">
                  ...
                  <p className="text-[13px] text-white/50 leading-relaxed mb-5">
                    You&apos;ll be redirected to Razorpay&apos;s secure checkout to start your subscription. Razorpay emails the invoice after a successful charge.
                  </p>
